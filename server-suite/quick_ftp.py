...
import sys,os
class quick_ftp(qt.QWidget):
	def stop_ftp(self,show_path):
		try:
			show_path.setText("<font color='black'>PATH:</font>\t"+"<font color='red'>"+self.file+"</font>")
		except:
			file=os.getcwd()
			show_path.setText("<font color='black'>PATH:</font>\t"+"<font color='red'>"+os.getcwd()+"</font>")
	...
	def work(self):
		...
		back=qt.QLabel("<img src='images/ftp-back.jpg' height='400' width='500'>",self)
		...
		q_ftp.clicked.connect(lambda:self.start_ftp())
		q_ftp.move(210,215)
